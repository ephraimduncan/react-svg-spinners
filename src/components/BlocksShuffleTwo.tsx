  ...
  return (
    ...
    >
      <rect x="1" y="1" rx="1" width="10" height="10">
        <animate id="a" begin="0;k.end" attributeName="x" dur={dur} values="1;13" fill="freeze" />
        <animate id="d" begin="b.end" attributeName="y" dur={dur} values="1;13" fill="freeze" />
        <animate id="g" begin="e.end" attributeName="x" dur={dur} values="13;1" fill="freeze" />
        <animate id="j" begin="h.end" attributeName="y" dur={dur} values="13;1" fill="freeze" />
      </rect>
